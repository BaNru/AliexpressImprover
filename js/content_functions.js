...
function RunTotalPrise() {
	...
	// Основная цена
	var price = document.querySelector('.product-price-current') || document.querySelector('.uniform-banner-box-price, [class*="uniformBannerBoxPrice"]');
	...
	// Доставка
	var shippingPrice = document.querySelector('[class*="Product_NewFreight__deliveryInfoWrapper"] + span .freight-extra-info-detail, [class*="NewFreight-module_deliveryInfoWrapper"] + span .freight-extra-info-detail, .product-shipping-price *, .product-shipping .freight-extra-info-detail:nth-child(2), .freight-extra-info-detail');
